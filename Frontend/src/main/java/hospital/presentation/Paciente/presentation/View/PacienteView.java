package hospital.presentation.Paciente.presentation.View;
...
import hospital.presentation.Paciente.presentation.PacienteTableModel;
...
public class PacienteView extends JPanel implements PropertyChangeListener {
    ...
    public void setListado(JPanel listado) {this.listado = listado;}
    public JPanel getPacientes() {return pacientes;}
    public void setPacientes(JPanel pacientes) {this.pacientes = pacientes;}
    // 🔹 Integración MVC
